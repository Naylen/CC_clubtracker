...
# ── Domain ───────────────────────────────────────────────────────────────────
# Your public-facing domain. Used to derive all URL-based config automatically.
# Example: club.mcfgcinc.com
...
# ── Database ─────────────────────────────────────────────────────────────────
# Credentials for the PostgreSQL container on the internal Docker network.
# DATABASE_URL is set in docker-compose.prod.yml from these values.
DB_USER=mcfgc
...
# ── Stripe (required — get from https://dashboard.stripe.com/apikeys) ────────
STRIPE_SECRET_KEY=
STRIPE_PUBLISHABLE_KEY=
STRIPE_WEBHOOK_SECRET=

# ── Resend (optional — get from https://resend.com/api-keys) ─────────────────
RESEND_API_KEY=

# ── Gmail SMTP (optional — see Google Account > App Passwords) ───────────────
GMAIL_USER=
GMAIL_APP_PASSWORD=
...
# ── App Port (port exposed on the host — Cloudflare Tunnel points here) ──────
APP_PORT=3001
ENVEOF
